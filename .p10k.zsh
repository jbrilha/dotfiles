# Generated by Powerlevel10k configuration wizard on 2024-05-25 at 06:23 WEST.
...
() {
  ...
  # typeset -g POWERLEVEL9K_DIR_BACKGROUND="#ff004f"
  # typeset -g POWERLEVEL9K_DIR_FOREGROUND="#000000"
  typeset -g POWERLEVEL9K_DIR_FOREGROUND="#ff004f"
